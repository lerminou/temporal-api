...
class GetWorkerBuildIdOrderingResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           The currently established default version
     *     @type \Temporal\Api\Taskqueue\V1\VersionIdNode[]|\Google\Protobuf\Internal\RepeatedField $compatible_leaves
     *           Other current latest-compatible versions who are not the overall default. These are the
     *           versions that will be used when generating new tasks by following the graph from the
     *           version of the last task out to a leaf.
     * }
     ...
     *
     * Generated from protobuf field <code>.temporal.api.taskqueue.v1.VersionIdNode current_default = 1;</code>
     * @return \Temporal\Api\Taskqueue\V1\VersionIdNode
     */
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.taskqueue.v1.VersionIdNode compatible_leaves = 2;</code>
     * @param \Temporal\Api\Taskqueue\V1\VersionIdNode[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
