...
{
    /**
     * Generated from protobuf field <code>repeated .temporal.api.cluster.v1.ClusterMetadata clusters = 1;</code>
     */
    private $clusters;
    /**
     ...
     *
     *     @type \Temporal\Api\Cluster\V1\ClusterMetadata[]|\Google\Protobuf\Internal\RepeatedField $clusters
    ...
    /**
     * Generated from protobuf field <code>repeated .temporal.api.cluster.v1.ClusterMetadata clusters = 1;</code>
     * @param \Temporal\Api\Cluster\V1\ClusterMetadata[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setClusters($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Temporal\Api\Cluster\V1\ClusterMetadata::class);
        $this->clusters = $arr;
